...
async function loadSceneModels() {
    try {
        ...
        spawnClones('manta', 'models/manta/scene.gltf', 10, null, { baseSpeed: 2, scaleMin: 2, scaleMax: 4 });
        spawnClones('shark', 'models/shark/scene.gltf', 0, null, { baseSpeed: 1.5, scaleMin: 0.01, scaleMax: 0.02 });
        spawnClones('koi_fish', 'models/koi_fish/scene.gltf', 10, null, { baseSpeed: 2.5, scaleMin: 0.8, scaleMax: 1 });
        spawnClones('turtle', 'models/turtle/scene.gltf', 6, null, { baseSpeed: 2, scaleMin: 10, scaleMax: 20 });
